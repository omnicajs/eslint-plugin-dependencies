/* Authorship: Hugo (https://github.com/hugop95). Source history: https://github.com/azat-io/eslint-plugin-perfectionist/commits/main/rules/sort-imports/read-closest-ts-config-by-path.ts */
