/* Authorship: Hugo (https://github.com/hugop95). Source history: https://github.com/azat-io/eslint-plugin-perfectionist/commits/main/rules/sort-imports/is-side-effect-only-group.ts */
