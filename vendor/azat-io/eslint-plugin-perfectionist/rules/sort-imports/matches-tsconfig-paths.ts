/* Authorship: Azat S. (https://github.com/azat-io). Source history: https://github.com/azat-io/eslint-plugin-perfectionist/commits/main/rules/sort-imports/matches-tsconfig-paths.ts */
