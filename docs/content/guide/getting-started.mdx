...
Before you start, take a moment to support the project by giving us a star on [GitHub](https://github.com/omnicajs/eslint-plugin-dependencies).
...
<CodeTabs
  code={[
    {
      source: 'npm install --save-dev @omnicajs/eslint-plugin-dependencies',
      name: 'npm',
      value: 'npm',
    },
    {
      source: 'pnpm add --save-dev @omnicajs/eslint-plugin-dependencies',
      name: 'pnpm',
      value: 'pnpm',
    },
    {
      source: 'yarn add --dev @omnicajs/eslint-plugin-dependencies',
      name: 'yarn',
      value: 'yarn',
    },
    {
      source: 'bun install --dev @omnicajs/eslint-plugin-dependencies',
      name: 'bun',
      value: 'bun',
    },
  ]}
    ...
    },
    {
      source: dedent`
        ...
        module.exports = {
          ...
          rules: {
            '@omnicajs/dependencies/sort-imports': 'error',
          },
        }
      `,
      name: 'Legacy Config',
      ...
      source: dedent`
        ...
        module.exports = {
          ...
          rules: {
            ...
            '@omnicajs/dependencies/sort-exports': ['error'],
          },
          settings: {
            dependencies: {
              type: 'line-length',
