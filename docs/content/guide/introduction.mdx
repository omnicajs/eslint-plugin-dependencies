...
We maintain [Changelog](https://github.com/omnicajs/eslint-plugin-dependencies/blob/main/changelog.md).

## License

See the [license file](https://github.com/omnicajs/eslint-plugin-dependencies/blob/main/license.md) for rights and limitations under the MIT License.
