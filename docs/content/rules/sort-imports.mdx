...
This rule was introduced in [v0.9.0](https://github.com/omnicajs/eslint-plugin-dependencies/releases/tag/v0.9.0).

## Resources

- [Rule source](https://github.com/omnicajs/eslint-plugin-dependencies/blob/main/rules/sort-imports.ts)
- [Test source](https://github.com/omnicajs/eslint-plugin-dependencies/blob/main/test/rules/sort-imports.test.ts)
