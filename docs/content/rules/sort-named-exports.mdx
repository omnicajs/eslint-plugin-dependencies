...
This rule was introduced in [v0.4.0](https://github.com/omnicajs/eslint-plugin-dependencies/releases/tag/v0.4.0).

## Resources

- [Rule source](https://github.com/omnicajs/eslint-plugin-dependencies/blob/main/rules/sort-named-exports.ts)
- [Test source](https://github.com/omnicajs/eslint-plugin-dependencies/blob/main/test/rules/sort-named-exports.test.ts)
