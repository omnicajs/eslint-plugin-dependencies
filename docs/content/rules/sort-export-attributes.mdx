...
This rule was introduced in [v5.0.0](https://github.com/omnicajs/eslint-plugin-dependencies/releases/tag/v5.0.0).

## Resources

- [Rule source](https://github.com/omnicajs/eslint-plugin-dependencies/blob/main/rules/sort-export-attributes.ts)
- [Test source](https://github.com/omnicajs/eslint-plugin-dependencies/blob/main/test/rules/sort-export-attributes.test.ts)
