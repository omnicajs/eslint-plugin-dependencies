...
This rule was introduced in [v1.2.0](https://github.com/omnicajs/eslint-plugin-dependencies/releases/tag/v1.2.0).

## Resources

- [Rule source](https://github.com/omnicajs/eslint-plugin-dependencies/blob/main/rules/sort-exports.ts)
- [Test source](https://github.com/omnicajs/eslint-plugin-dependencies/blob/main/test/rules/sort-exports.test.ts)
