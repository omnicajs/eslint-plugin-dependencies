...
description: Get started with our ESLint Plugin Dependencies by following this comprehensive guide. Learn how to install, configure, and use our tool to maintain a consistent and high-quality codebase
keywords:
  - eslint
  - introduction
  - eslint plugin
...
Add `dependencies` to the plugins section of your ESLint configuration. Then configure the rules you want to use under the rules section.
