...
description:
  Keep import attributes consistently ordered for clearer, more maintainable
  imports. This rule sorts attributes defined with the import attributes syntax
...
This rule keeps attributes inside `import ... with { ... }` consistently
