...
Controls partitioning behavior for export attributes.
...
export default [
  {
    ...
    rules: {
      'dependencies/sort-export-attributes': [
        'error',
        {
          type: 'alphabetical',
          order: 'asc',
...
- [Rule source](../../rules/sort-export-attributes.ts)
- [Test source](../../test/rules/sort-export-attributes.test.ts)
